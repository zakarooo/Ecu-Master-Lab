...
ECU_SIGNATURES_DB: List[Dict] = [
    {"ecu_id": "BOSCH_EDC17C64", "manufacturer": "Bosch",
     ...
     "modifications": ["Stage 1", "Stage 2", "Stage 3", "EGR OFF", "DPF OFF", "AdBlue OFF", "Start/Stop OFF", "Vmax", "DTC OFF", "Immo OFF"],
     "protocol": "CAN"},
    {"ecu_id": "BOSCH_EDC17CP44", "manufacturer": "Bosch",
     ...
     "file_sizes": [{"size": 524288, "tolerance": 0.1}, {"size": 1048576, "tolerance": 0.1}],
     "processor_family": "Tricore",
     "modifications": ["Stage 1", "Stage 2", "Stage 3", "EGR OFF", "DPF OFF", "Vmax", "DTC OFF"],
     "protocol": "CAN"},
    {"ecu_id": "BOSCH_EDC17CP14", "manufacturer": "Bosch",
     "ecu_family": "EDC17", "ecu_model": "EDC17CP14",
     "known_hw_versions": ["0 281 030 219", "0 281 030 220", "0 281 030 292"],
     "known_sw_versions": ["1037343991", "1037456014", "03L906022B"],
     "known_brands": ["Volkswagen", "Audi", "Seat", "Skoda"],
     "known_engines": ["2.0 TDI", "1.9 TDI", "1.6 TDI"],
     "file_sizes": [{"size": 1048576, "tolerance": 0.1}, {"size": 2097152, "tolerance": 0.1}],
     "processor_family": "Tricore",
     "modifications": ["Stage 1", "Stage 2", "Stage 3", "EGR OFF", "DPF OFF", "AdBlue OFF", "Start/Stop OFF", "Vmax", "Pop & Bang", "DTC OFF", "Immo OFF", "Lambda OFF"],
     "protocol": "CAN"},
    {"ecu_id": "BOSCH_EDC17CP04", "manufacturer": "Bosch",
     "ecu_family": "EDC17", "ecu_model": "EDC17CP04",
     "known_hw_versions": ["0 281 030 136", "0 281 030 137"],
     "known_sw_versions": ["1037343991", "1037456004"],
     "known_brands": ["Volkswagen", "Audi", "BMW", "Opel"],
     "known_engines": ["2.0 TDI", "3.0 TDI", "1.9 TDI"],
     "file_sizes": [{"size": 524288, "tolerance": 0.1}, {"size": 1048576, "tolerance": 0.1}],
     "processor_family": "Tricore",
     "modifications": ["Stage 1", "Stage 2", "EGR OFF", "DPF OFF", "Vmax", "DTC OFF"],
     "protocol": "CAN"},
    {"ecu_id": "BOSCH_EDC17CP02", "manufacturer": "Bosch",
     "ecu_family": "EDC17", "ecu_model": "EDC17CP02",
     "known_hw_versions": ["0 281 030 052", "0 281 030 053"],
     "known_sw_versions": ["1037343991"],
     "known_brands": ["Volkswagen", "Audi", "Porsche"],
     "known_engines": ["3.0 TDI", "2.7 TDI"],
     "file_sizes": [{"size": 524288, "tolerance": 0.1}, {"size": 1048576, "tolerance": 0.1}],
     "processor_family": "Tricore",
     "modifications": ["Stage 1", "Stage 2", "EGR OFF", "DPF OFF", "Vmax", "DTC OFF"],
     "protocol": "CAN"},
    {"ecu_id": "BOSCH_EDC17CP09", "manufacturer": "Bosch",
     "ecu_family": "EDC17", "ecu_model": "EDC17CP09",
     "known_hw_versions": ["0 281 030 320", "0 281 030 321"],
     "known_sw_versions": ["1037343991"],
     "known_brands": ["BMW"],
     "known_engines": ["3.0 diesel", "3.0D"],
     "file_sizes": [{"size": 1048576, "tolerance": 0.1}, {"size": 2097152, "tolerance": 0.1}],
     "processor_family": "Tricore",
     "modifications": ["Stage 1", "Stage 2", "EGR OFF", "DPF OFF", "Vmax", "DTC OFF"],
     "protocol": "CAN"},
    {"ecu_id": "BOSCH_EDC17C46", "manufacturer": "Bosch",
     "ecu_family": "EDC17", "ecu_model": "EDC17C46",
     "known_hw_versions": ["0 281 030 643", "0 281 030 644"],
     "known_sw_versions": ["1037556117"],
     "known_brands": ["Volkswagen", "Audi", "Seat", "Skoda"],
     "known_engines": ["2.0 TDI", "1.6 TDI"],
     "file_sizes": [{"size": 1048576, "tolerance": 0.1}, {"size": 2097152, "tolerance": 0.1}],
     "processor_family": "Tricore",
     "modifications": ["Stage 1", "Stage 2", "Stage 3", "EGR OFF", "DPF OFF", "AdBlue OFF", "Vmax", "Pop & Bang", "DTC OFF"],
     "protocol": "CAN"},
    ...
    {"ecu_id": "BOSCH_MD1CS004", "manufacturer": "Bosch",
     ...
     "processor_family": "Tricore",
     "modifications": ["Stage 1", "Stage 2", "EGR OFF", "DPF OFF", "AdBlue OFF", "Vmax"],
     "protocol": "CAN"},
    {"ecu_id": "BOSCH_ME7_1", "manufacturer": "Bosch",
     "ecu_family": "ME7", "ecu_model": "ME7.1",
     "known_hw_versions": ["0 281 027 050", "0 281 027 051", "0 281 027 200"],
     "known_sw_versions": ["1037450801", "1037450901"],
     "known_brands": ["Volkswagen", "Audi"],
     "known_engines": ["1.8 T", "1.8 TURBO", "2.7 V6", "4.2 V8"],
     "file_sizes": [{"size": 524288, "tolerance": 0.1}, {"size": 1048576, "tolerance": 0.1}],
     "processor_family": "Tricore",
     "modifications": ["Stage 1", "Stage 2", "Stage 3", "Pop & Bang", "Launch Control", "Vmax", "DTC OFF"],
     "protocol": "CAN"},
    {"ecu_id": "BOSCH_ME7_5", "manufacturer": "Bosch",
     "ecu_family": "ME7", "ecu_model": "ME7.5",
     "known_hw_versions": ["0 281 027 411", "0 281 027 412", "0 281 027 200"],
     "known_sw_versions": ["1037462001"],
     "known_brands": ["Volkswagen", "Audi"],
     "known_engines": ["1.8 T", "1.8 TURBO", "2.0 TFSI"],
     "file_sizes": [{"size": 524288, "tolerance": 0.1}, {"size": 1048576, "tolerance": 0.1}],
     "processor_family": "Tricore",
     "modifications": ["Stage 1", "Stage 2", "Pop & Bang", "Vmax"],
     "protocol": "CAN"},
    {"ecu_id": "BOSCH_MED17_1", "manufacturer": "Bosch",
     "ecu_family": "MED17", "ecu_model": "MED17.1",
     "known_hw_versions": ["0 281 027 343", "0 281 027 344"],
     "known_sw_versions": ["1037463001", "1037463010"],
     "known_brands": ["Volkswagen", "Audi", "Mercedes"],
     "known_engines": ["1.8 TFSI", "2.0 TFSI", "1.4 TSI"],
     "file_sizes": [{"size": 2097152, "tolerance": 0.1}, {"size": 4194304, "tolerance": 0.1}],
     "processor_family": "Tricore",
     "modifications": ["Stage 1", "Stage 2", "Pop & Bang", "Hardcut", "Launch Control", "Vmax", "DTC OFF", "Start/Stop OFF"],
     "protocol": "CAN"},
    {"ecu_id": "BOSCH_MED9_1", "manufacturer": "Bosch",
     "ecu_family": "MED9", "ecu_model": "MED9.1",
     "known_hw_versions": ["0 281 028 101", "0 281 028 102"],
     "known_sw_versions": ["1037495001"],
     "known_brands": ["Volkswagen", "Audi"],
     "known_engines": ["2.0 TFSI", "3.6 FSI", "4.2 FSI"],
     "file_sizes": [{"size": 2097152, "tolerance": 0.1}, {"size": 4194304, "tolerance": 0.1}],
     "processor_family": "Tricore",
     "modifications": ["Stage 1", "Stage 2", "Pop & Bang", "Vmax", "DTC OFF"],
     "protocol": "CAN"},
    {"ecu_id": "DELPHI_DCM3_7", "manufacturer": "Delphi",
     ...
     "file_sizes": [{"size": 524288, "tolerance": 0.1}, {"size": 1048576, "tolerance": 0.1}],
     "processor_family": "Tricore",
     "modifications": ["Stage 1", "EGR OFF", "DPF OFF", "Vmax", "DTC OFF"],
     "protocol": "CAN"},
    {"ecu_id": "CONTINENTAL_SID208", "manufacturer": "Continental",
     ...
     "file_sizes": [{"size": 2097152, "tolerance": 0.1}, {"size": 4194304, "tolerance": 0.1}],
     "processor_family": "Tricore",
     "modifications": ["Stage 1", "EGR OFF", "DPF OFF", "Vmax"],
     "protocol": "CAN"},
    {"ecu_id": "CONTINENTAL_SID803A", "manufacturer": "Continental",
     "ecu_family": "SID803", "ecu_model": "SID803A",
     "known_hw_versions": ["A2C813359001", "A2C813359002"],
     "known_sw_versions": ["1037738001"],
     "known_brands": ["Peugeot", "Citroen", "Volvo"],
     "known_engines": ["2.0 HDi", "2.2 HDi"],
     "file_sizes": [{"size": 1048576, "tolerance": 0.1}, {"size": 2097152, "tolerance": 0.1}],
     "processor_family": "Tricore",
     "modifications": ["Stage 1", "EGR OFF", "DPF OFF", "Vmax"],
     "protocol": "CAN"},
    {"ecu_id": "CONTINENTAL_SID807EVO", "manufacturer": "Continental",
     ...
     "file_sizes": [{"size": 2097152, "tolerance": 0.1}, {"size": 4194304, "tolerance": 0.1}],
     "processor_family": "Tricore",
     "modifications": ["Stage 1", "EGR OFF", "DPF OFF", "AdBlue OFF", "Vmax"],
     "protocol": "CAN"},
    {"ecu_id": "SIEMENS_SIMOS18_1", "manufacturer": "Siemens",
     ...
     "file_sizes": [{"size": 2097152, "tolerance": 0.1}, {"size": 4194304, "tolerance": 0.1}],
     "processor_family": "Tricore",
     "modifications": ["Stage 1", "Stage 2", "Pop & Bang", "Launch Control", "Vmax", "DTC OFF"],
     "protocol": "CAN"},
    {"ecu_id": "SIEMENS_SIMOS18_2", "manufacturer": "Siemens",
     ...
     "modifications": ["Stage 1", "Stage 2", "Pop & Bang", "Vmax"],
     "protocol": "CAN"},
    {"ecu_id": "SIEMENS_SIMOS8_2", "manufacturer": "Siemens",
     "ecu_family": "Simos", "ecu_model": "Simos 8.2",
     "known_hw_versions": ["5WP4 256 193-001"],
     "known_sw_versions": ["1037385100"],
     "known_brands": ["Audi"],
     "known_engines": ["1.8 T", "2.0 T"],
     "file_sizes": [{"size": 524288, "tolerance": 0.1}, {"size": 1048576, "tolerance": 0.1}],
     "processor_family": "Tricore",
     "modifications": ["Stage 1", "Stage 2", "Vmax"],
     "protocol": "CAN"},
    ...
    {"ecu_id": "MAGNETI_MARELLI_9GF", "manufacturer": "Magneti Marelli",
     ...
     "modifications": ["Stage 1", "EGR OFF", "DPF OFF", "Vmax"],
     "protocol": "CAN"},
    {"ecu_id": "BOSCH_EDC15", "manufacturer": "Bosch",
     "ecu_family": "EDC15", "ecu_model": "EDC15",
     "known_hw_versions": ["0 281 010 XXX"],
     "known_sw_versions": ["1037343000"],
     "known_brands": ["Volkswagen", "Audi", "Seat", "Skoda", "Opel", "BMW", "Mercedes"],
     "known_engines": ["1.9 TDI", "2.0 TDI", "2.5 TDI", "3.0 TDI"],
     "file_sizes": [{"size": 262144, "tolerance": 0.1}, {"size": 524288, "tolerance": 0.1}],
     "processor_family": "ST10",
     "modifications": ["Stage 1", "Stage 2", "EGR OFF", "DPF OFF", "Vmax", "DTC OFF"],
     "protocol": "KWP"},
    {"ecu_id": "BOSCH_EDC16", "manufacturer": "Bosch",
     "ecu_family": "EDC16", "ecu_model": "EDC16",
     "known_hw_versions": ["0 281 019 XXX"],
     "known_sw_versions": ["1037383000"],
     "known_brands": ["Volkswagen", "Audi", "BMW", "Mercedes", "Opel"],
     "known_engines": ["1.9 TDI", "2.0 TDI", "2.5 TDI", "3.0 TDI"],
     "file_sizes": [{"size": 524288, "tolerance": 0.1}, {"size": 1048576, "tolerance": 0.1}],
     "processor_family": "ST10",
     "modifications": ["Stage 1", "Stage 2", "EGR OFF", "DPF OFF", "Vmax", "DTC OFF"],
     "protocol": "KWP"},
    {"ecu_id": "BOSCH_MED17_5_1", "manufacturer": "Bosch",
     "ecu_family": "MED17", "ecu_model": "MED17.5.1",
     "known_hw_versions": ["0 281 033 615", "0 281 033 616"],
     "known_sw_versions": ["1037565030"],
     "known_brands": ["Volkswagen", "Audi", "Seat", "Skoda"],
     "known_engines": ["1.4 TSI", "1.2 TSI"],
     "file_sizes": [{"size": 2097152, "tolerance": 0.1}, {"size": 4194304, "tolerance": 0.1}],
     "processor_family": "Tricore",
     "modifications": ["Stage 1", "Stage 2", "Pop & Bang", "Vmax"],
     "protocol": "CAN"},
...
def _query_ecu_models_from_db(db, tech_info, data_size, db_candidates):
    ...
    for model in ecu_models:
        ...
        cand = ECUCandidate(
            ecu_id="REF_%s" % model.model_name.upper().replace(" ", "_"),
        ...
        try:
            ...
            for dc in db_raw:
                if dc["score"] < 10.0:
                    continue
                cand = ECUCandidate(
                    ecu_id="DB_%s" % dc["ecu_model_name"].upper().replace(" ", "_"),

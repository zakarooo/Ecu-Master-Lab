...
export default function EcuModelsPage() {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      const res = await api.v2.ecuModels.list(params.toString());
      setData(res.items || []);
      ...
      <main className="flex-1 p-8 ml-64">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-3xl font-bold text-white mb-6">
            <span className="gradient-text">Modèles ECU</span>
          </h1>

          <div className="glass rounded-xl p-4 mb-6 flex gap-4">
            <input
              type="text"
              placeholder="Rechercher un modèle ECU..."
              value={search}
              onChange={(e) => {
          ...
          <div className="glass rounded-xl overflow-hidden">
            {loading ? (
              ...
              <div className="p-8 text-center text-white/50">Aucun modèle ECU trouvé</div>
            ) : (
